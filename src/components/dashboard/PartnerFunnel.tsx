...
const PartnerFunnel = ({ data }) => {
  return (
    <Card className="col-span-8 border-none bg-[#CFFF4D] rounded-[32px] p-8 pb-6 shadow-none overflow-hidden">
      ...
      <div className="flex items-end gap-4 mb-16">
        <span className="text-[72px] font-semibold tracking-tight text-black leading-none">
          +37%
        </span>
      ...
      <div className="grid grid-cols-4 gap-8 items-end">
        <div className="flex flex-col gap-1">
          ...
          <div className="h-24 rounded-2xl bg-[#A9D13D]" />
        </div>
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="h-20 rounded-2xl bg-[#BEE35A]" />
        </div>
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="h-14 rounded-2xl bg-[#DDF79A]" />
        </div>
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="h-12 rounded-full bg-[#111111]" />
        </div>
      </div>
    </Card>
  );
